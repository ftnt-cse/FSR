...
#### Input parameters
<table border=1><thead><tr><th>Parameter<br></th><th>Description<br></th></tr></thead><tbody><tr><td>Method<br></td><td>RPC Command to run<br>
</td></tr><tr><td>Custom Method<br></td><td>if the command is not in the list above you can use a custom one here. To get the exact command syntax use this example on JunOS: show route|display xml rpc<br>
</td></tr><tr><td>Method Parameters<br></td><td>Method parameters in JSON<br>
</td></tr></tbody></table>
#### Output
...
#### Input parameters
<table border=1><thead><tr><th>Parameter<br></th><th>Description<br></th></tr></thead><tbody><tr><td>Request Payload<br></td><td>XML Payload<br>
</td></tr></tbody></table>
#### Output
The output contains the following populated JSON schema:
